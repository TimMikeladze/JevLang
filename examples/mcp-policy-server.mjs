#!/usr/bin/env node
// A policy as an MCP server over stdio: `node examples/mcp-policy-server.mjs`.
// Nothing but protocol goes to stdout.
import { policyMcpServer, serveStdio, mcpTool, mcpTextResult, mcpInputRequired, makeMcpServer } from '../src/mcp.mjs';
import { policy as ticket } from './ticket-router.mjs';
